...
void MeshStripper::AddEdge(int tnum, int vnum1, int vnum2)
{
	...
	else
	{
		...
		//
		// Did you crash here?  Maybe you forgot to
		// add a UV Map?
		//
...
/*
gOut.Out("");
gOut.Out("Search for: %f,%f,%f (%f,%f,%f) %f,%f",
		 v->mX,v->mY,v->mZ,
		 v->mNormalX,v->mNormalY,v->mNormalZ,
		 v->mTextureU,v->mTextureV);
*/
